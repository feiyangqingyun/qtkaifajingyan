1. 1. ### 一、开发经验
      ...
      **经验总结**
      ...
      12. 在Qt界始终有两大阵营产生激烈的纷争，那就是选用qml还是wigdget好，大量初学者也会问这个问题，有以下几点总结。
      - widget属于传统界面开发，和VB/VC/Delphi等拖曳控件开发类似，走CPU绘制，能最大化的兼容现有的硬件和过去的低性能的硬件。
      - qml属于新时代的产物，大概2010年开始，和WPF/flutter/Electron等web开发框架及移动开发框架类似，为了适应各种移动端开发及动画流畅性体验、充分利用和榨干现在的GPU性能，最大化发挥。
      ...
      - 目前国内widget多于qml，国外可能偏向qml，这个不难看出，流行的移动端开发框架都是国外开发的居多。
      - 可预见的十年内，这两者将长期并存，官方基本不再更新widget而是主推qml，未来趋势是qml。
      - 有的时候不禁要问，既生widget何生qml，学习成本和选择又多了，其实这正是和这个世界的哲学一样：世界是简单的又是复杂的。为了适应各种需求和满足需要。
      - 总之，无论qml还是widget，和找老婆一样，适合自己的就是最好的，自己擅长哪个就用哪个。
      - 如果还不知道擅长哪个，有空就两个都学，自己就会有对比。能够顺利的最快的完成老板的任务给老板赚钱才是王道。
